...
//				}
//				public void setTime(int h, int m, int s)					//this is what we will use to call the methods to set hour, minute and second
//				{
//					setHour(h);
//					setMinute(m);
//					setSecond(s);
...
//				{										
//					hour = ((h >= 0 && h < 12)? h:0);						//this checks if hour is more than or equal to zero and less than 24. if not then set it to 0
//				}				
...
//				}
//				
//				public int getHour()										//this returns hour
//				{
//					return hour; 
//				}
//				public int getMinute()										//this returns minute
//				{
//					return minute;
//				}
//				public int getSecond()										//this returns second
//				{
//					return second;
//				}
//				
...
//				{
//					return String.format("%02d:%02d:%02d", getHour(), getMinute(), getSecond() ); // %02d means that it will have two decimal places
//				}
//				
//			//***********************************************************************************************************************************************//
